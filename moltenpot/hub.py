...
-------------------------
    ...
    hub.configure(repo_id="yourname/moltenpot-datasets", auto_download=True)
...
Bulk upload
-----------
    python scripts/upload_dataset.py --repo-id yourname/moltenpot-datasets \\
        --data-root data --substrate clean_up
"""
